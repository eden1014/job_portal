...
if(isset($_POST['submit'])){
   ...
   //$_FILES  contain item uploaded vi http post method
   $pname=$_FILES["file_tu"]["name"];//original name of file to be uploaded
   $tname=$_FILES["file_tu"]["tmp_name"];//temporary filename of file in which uploaded file was stored on server
   //specifies the directory where the file is going to be placed  
   $uploads_dir='uploads/';
   //move file from tname in to uploads with pname
