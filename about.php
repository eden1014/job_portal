...
<section class="home-about">
   ...
   <div class="image">
      <img src="images/about-1.png.png" alt="k">
   </div>

   <div class="content">
      <h3>We're not your typical job site.</h3>
      <p>We are different and makes it easier to find your next great opportunity.We are dedicated to providing job seekers with the clearest path to their next amazing opportunity.</p>
      
   </div>
   <div class="content">
      <h3>We're not your typical job site.</h3>
      <p>That mission is written in our DNA. It’s who we are. It’s what drives us. Because we know it’s more than a career move, it’s helping people find their purpose.</p>
   </div>
   <div class="image">
    ...
    <div class="container-fluid">
        ...
        <section class="home-testimonial-bottom">
            <div class="container testimonial-inner">
                <div class="row d-flex justify-content-center"> <p> <?php
        @include 'config.php';
...
<section class="services"style="padding: 0">
   ...
   <div class="box-container">
      ...
      <div class="box" >
         ...
         <div class="box" >
         <img src="images\nati.jfif"style="height:15vh" alt="">
         <h3>Nati</h3>
         </div>
      ...
      <div class="box">
         <img src="images\suzi.jfif" style="height:15vh"alt="">
         <h3>Aziza</h3>
           </div>
